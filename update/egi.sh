...
cd $HOME
rm -rf bigtool/
git clone https://github.com/egiusta/bigtool
termux-notification -t "Tool kullanıma hazır"
;;
...
clear
cd $HOME/ &&
cd bigtool/exploit/ && bash tst.sh
;;
...
clear
cd $HOME/ &&
cd bigtool/phishing/ && bash tst.sh
...
clear
cd $HOME/ &&
cd bigtool/bruteforce/ && bash tst.sh
...
clear
cd $HOME/ &&
cd bigtool/pentest/ && bash tst.sh
...
clear
cd $HOME/ &&
cd bigtool/termux-api/ && bash tst.sh
